...
function BrandHeader({ branding }: { branding: WorkspaceBranding | null }) { return <header className="public-header"><div className="booking-brand"><BrandLogo branding={branding} /><div><strong>{branding?.workspaceName || "Dvision Studio"}</strong><span>{branding?.description || "By appointment"}</span></div></div></header>; }
